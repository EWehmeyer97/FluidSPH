...
public class ParticleDisplay3D : MonoBehaviour
{
    ...
    public void Init(Simulation3D sim)
    {
        ...
        mat.SetBuffer("Particles", sim.particleBuffer);
    ...
    private void TextureFromGradient(ref Texture2D texture, int width, Gradient gradient, FilterMode filterMode = FilterMode.Bilinear)
    {
        if (texture == null)
        {
